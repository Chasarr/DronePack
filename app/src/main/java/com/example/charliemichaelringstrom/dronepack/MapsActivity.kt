...
class MapsActivity : BaseActivity(),    //Extends BaseActivity to inherit it's basic features
    ...
    private val ipAddress = "ip-address"  //Sensitive information, not to be shared on GitHub
    private val port = portNumber    //Sensitive information, not to be shared on GitHub
